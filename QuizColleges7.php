...
<nav>
 ...
 <table class="content-table"  cellspacing="50" > 
    ...
    if($conn){
        $sql = " SELECT CllgName,Rank,Cutoff,Estd_Year,Approval,filename,Q1,Q2,Q3,Q4,Q5,Q6,Q7,Q8,Q9,Q10,Q11,Q12,Q13,Q14 from  CollegeDataBase where Q7 = 'Q7' || Q9 = 'Q9' &&  Q10 = 'Q10' ";
