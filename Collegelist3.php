...
<nav>
    ...
    <table class="content-table"  cellspacing="50" >
     ...
     $sql = " SELECT id, CllgName,Rank,Cutoff,Total_Faculty,Estd_Year,Approval,filename from  CollegeDataBase  WHERE Rank BETWEEN 40 AND 200  ";
     ...
     if ($result-> num_rows > 0) {
         while ($row = $result-> fetch_assoc()) {
          ...
          <td >Approval<h2><?php echo $row["Approval"]; ?></h2></td>0
          </tr>
          <?php
         }
        echo "</table>";
